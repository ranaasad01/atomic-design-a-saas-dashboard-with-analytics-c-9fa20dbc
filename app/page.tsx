    ...
    <main className="bg-slate-950 text-white overflow-x-hidden">
      ...
      <section className="relative py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <motion.p
              variants={shouldReduceMotion ? {} : fadeInUp}
              className="text-sky-400 text-sm font-semibold uppercase tracking-widest mb-3"
            >
              Loved by teams
            </motion.p>
            <motion.h2
            ...
            >
              Over 2,400 SaaS teams rely on {APP_NAME} to make faster, smarter decisions every day.
            </motion.p>
          </motion.div>
          ...
          >
            {testimonials.map((t) => (
              <motion.div
                ...
                className="rounded-2xl bg-slate-900/80 border border-slate-700/50 p-6 flex flex-col gap-4"
              >
                {/* Stars */}
          ...
          >
            {pricingPlans.map((plan) => (
              <motion.div
                ...
                className={`relative rounded-2xl border p-7 flex flex-col gap-5 cursor-pointer transition-all duration-200 ${
                  plan.highlighted
              ...
              >
                {plan.highlighted && (
                  <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 px-3 py-1 rounded-full bg-gradient-to-r from-indigo-500 to-violet-600 text-white text-xs font-bold shadow-lg">
                    Most popular
                  </div>
                )}
                <div>
                ...
                <Link href="/dashboard" className="mt-auto">
                  <motion.span
                    ...
                    whileTap={{ scale: 0.97 }}
                    className={`inline-flex w-full items-center justify-center gap-2 px-5 py-3 rounded-xl font-semibold text-sm transition-all duration-200 cursor-pointer ${
                      plan.highlighted
      ...
      <section className="relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        >
          <motion.div
            variants={shouldReduceMotion ? {} : scaleIn}
            className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-br from-indigo-500 to-violet-600 shadow-xl shadow-indigo-500/30 mb-8"
          >
          ...
          >
            Join 2,400+ SaaS teams who replaced spreadsheets and fragmented tools with a single
            source of truth. Set up in under 10 minutes.
          </motion.p>
          ...
          >
            <Link href="/dashboard">
              <motion.span
                ...
                whileTap={{ scale: 0.97 }}
                className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-gradient-to-r from-indigo-500 to-violet-600 text-white font-bold text-base shadow-xl shadow-indigo-500/30 hover:shadow-indigo-500/50 transition-shadow duration-300 cursor-pointer"
              >
            ...
            <Link href="/analytics">
              <motion.span
                whileHover={{ scale: shouldReduceMotion ? 1 : 1.04 }}
                whileTap={{ scale: 0.97 }}
                className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-transparent border border-slate-600 text-slate-300 font-semibold text-base hover:border-slate-400 hover:text-white transition-all duration-200 cursor-pointer"
              >
